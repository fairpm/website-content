...
The two groups have worked in parallel and collaborated from the outset of FAIR. Most notably FAIR adopted with the [AspireCloud project](https://github.com/fairpm/aspirecloud), which indexes and serves alternative download/update links for packages originating from [wordpress.org](http://wordpress.org) repositories and [TYPO3 Extension Repository](https://extensions.typo3.org/). Originally replicating responses to the WordPress API, AspireCloud’s purpose has expanded to also serve as a FAIR Aggregator for FAIR Repositories as well as existing WordPress and TYPO3 packages.
